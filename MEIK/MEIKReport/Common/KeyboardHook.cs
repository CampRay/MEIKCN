...
namespace MEIKReport.Common
{
    ...
    public class KeyboardHook : GlobalHook
    {
        ...
        //public event System.Windows.Input.KeyEventHandler OnKeyDown;
        //public event System.Windows.Input.KeyEventHandler OnKeyUp;
        ...
        protected override int HookCallbackProcedure(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if (nCode > -1 && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                ////把键盘码转换成Key，好明确具体是什么键
                //System.Windows.Input.Key keyObj = System.Windows.Input.KeyInterop.KeyFromVirtualKey(keyData);                
